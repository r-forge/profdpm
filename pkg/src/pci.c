...
/*
   ...
   The pci function computes some statstics used to 
   compare two cluster partitions. The statistics 
   are the Rand index, Wallace coefficients, and 
   the Fowlkes and Mallows index.

   1. Rand, W. (1971). Objective Criteria for the Evaluation
      of Clustering Methods. JASA 66:846-850.
   2. Fowlkes, E. B. and Mallows, C. L. (1983). A Method for
      Comparing Two Hierarchical Clusterings. JASA 78:553-569.
   3. Wallace, D. L. (1983). A Method for Comparing Two 
      Hierarchical Clusterings: Comment. JASA 78:569-576. 
 */
